...
Ported from the oil-subtitle skill's learn_glossary.py; logic unchanged.
"""
...
from videotrans.config import resolve_glossary_path
from videotrans.dashscope_client import call_qwen_multimodal_json
...
DEFAULT_LEARN_MODEL = "qwen3.7-flash"
DEFAULT_CONFIDENCE_THRESHOLD = 0.97
